...
# Package ID: edi.244.13 Cataloging System:https://pasta.edirepository.org.
# Data set title: Interagency Ecological Program: Over four decades of juvenile fish monitoring data from the San Francisco Estuary, collected by the Delta Juvenile Fish Monitoring Program, 1976-2024.
...
inUrl1  <- "https://pasta.lternet.edu/package/data/eml/edi/244/13/71c16ead9b8ffa4da7a52da180f601f4" 
infile1 <- tempfile()
...
inUrl2  <- "https://pasta.lternet.edu/package/data/eml/edi/244/13/71eccdb6cacf11aa6435ec8196897f65" 
infile2 <- tempfile()
...
inUrl3  <- "https://pasta.lternet.edu/package/data/eml/edi/244/13/2c186d27a149f07972c6065c8510f945" 
infile3 <- tempfile()
...
summary(as.factor(dt3$SpecialStudy)) 
...
inUrl4  <- "https://pasta.lternet.edu/package/data/eml/edi/244/13/17c9974d9b7b0125c146a887f3c64bd8" 
infile4 <- tempfile()
...
inUrl5  <- "https://pasta.lternet.edu/package/data/eml/edi/244/13/99a038d691f27cd306ff93fdcbc03b77" 
infile5 <- tempfile()
...
# remaining objects should be
# dt1: trawl data
# dt2: trawl data
# dt3: seine data
# dt4: taxanomic meta data
# dt5: GIS data (station locations, includes MethodCode)
...
## QAQC -----
# check seine volume, turbidity, turbidity_fnu, specific_conductance
# all basically looks fine
...
## reduce -----
# reduced variable number & remove fish NOT identified to species
temp <- 
  temp %>% 
  ...
  filter(!grepl("unknown", common_name))
