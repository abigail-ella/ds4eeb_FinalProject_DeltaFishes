...
dt1 <- readRDS("Pete_local_data/dt1.rds") # trawl 1978-2001
dt2 <- readRDS("Pete_local_data/dt2.rds") # trawl 2002-2025
dt3 <- readRDS("Pete_local_data/dt3.rds") # beach seines
dt4 <- readRDS("Pete_local_data/dt4.rds") # names and tagging meta data
dt5 <- readRDS("Pete_local_data/dt5.rds") # GIS data for locations & stations
...
write_rds(seine_long, "Pete_local_data/seine.rds")
...
```{r}
temp <- seine_all_var[1:6, c(1,4,21,22)]
temp %>% mutate(common_name = as.character(common_name))
temp %>% filter(str_detect(common_name, "//unknown$"))
temp %>% filter(str_detect(common_name, "//almon$"))

temp %>% filter(endsWith(common_name, "nown"))
