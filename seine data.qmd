...
```{r}
library(vegan)
specnumber(seine_w[c(9:128)])
specnumber(unlist(seine_w[,c(9:128)])) # Number of species per site

diversity(seine_w, index = "shannon") # Shannon index
diversity(seine_w, index = "simpson") # Simpson index
H <- diversity(seine_w, "shannon")
S <- specnumber(seine_w)
(J <- H / log(S))
```
